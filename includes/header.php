...
<body>
    <div class="container">
        <header class="mb-5">
            <h1 class="text-center mt-2"><a href="/" class="text-decoration-none">Mircea Blog</a></h1>
            <nav class="navbar bg-dark border-bottom border-body justify-content-center" data-bs-theme="dark">
                <ul class="nav">
                    ...
                    <?php if (Auth::isLoggedIn()): ?>
                        <li class="nav-item"><a class="nav-link" href="/admin/"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="16" fill="currentColor" class="bi bi-person-badge"
                                    viewBox="0 0 16 16">
                    ...
                    <ul class="nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="/logout.php"><svg xmlns="http://www.w3.org/2000/svg"
